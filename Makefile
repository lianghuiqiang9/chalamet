...
NUMBER_OF_ELEMENTS_EXP=16		  	# 数据库大小为 2^16
LWE_DIMENSION=1774 # as per FrodoPIR paper # LWE 的维度 n
ELEMENT_SIZE_BITS=8192 # 2**13   	# 每一个数据库的条目大小为 8192b 
PLAINTEXT_SIZE_EXP=10			 	# 明文模为10
NUM_SHARDS=8						# 这个是什么意思？
DB=true
KV=true
...
DB_ENV=DB_FILE=${PREVIOUS_DIR}/${DB_FILE_PATH} PARAMS_OUTPUT_PATH=${PREVIOUS_DIR}/${PARAMS_OUTPUT_PATH} # 设置输出路径
...
bench-keyword-20-256:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=288 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-20-256.txt
bench-keyword-20-512:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=544 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-20-512.txt
bench-keyword-20-1024:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=1056 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-20-1024.txt
bench-keyword-20-2048:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=2048 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-20-2048.txt
bench-keyword-22-256:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=288 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-22-256.txt
bench-keyword-22-512:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=544 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-22-512.txt
bench-keyword-22-1024:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=1056 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-22-1024.txt
bench-keyword-22-2048:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=2048 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-22-2048.txt

bench-keyword-20-22-256-2048:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=288 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-20-256.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=544 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-20-512.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=1056 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-20-1024.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=2048 PIR_NUMBER_OF_ELEMENTS_EXP=20 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-20-2048.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=288 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-22-256.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=544 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-22-512.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=1056 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-22-1024.txt
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=2048 PIR_NUMBER_OF_ELEMENTS_EXP=22 PIR_PLAINTEXT_BITS=9 BENCH_DB_GEN=false BENCH_KV=true ${CARGO} bench > benchmarks-22-2048.txt
