...
bench-keyword-lhq:
	${PRELIM} ${PIR_ENV_ALL} PIR_ELEM_SIZE_BITS=56 PIR_NUMBER_OF_ELEMENTS_EXP=16 PIR_PLAINTEXT_BITS=10 BENCH_DB_GEN=true BENCH_KV=true ${CARGO} bench > benchmarks-16-56b-lhq.txt
